...
--
-- Servidor: localhost
-- Tiempo de generación: 27-07-2016 a las 03:22:21
...
--
CREATE DATABASE `flashbd` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `flashbd`;
...
(12, 'romualdo', 'pereyra', 'guemes 76767', '43109869', '', 'paredes');
...
('bebidas', 'coca cola', 1, NULL, 20, 40, 'paredes'),
('bebidas', 'coca cola 3 litros', 45, NULL, 10, 59, 'paredes'),
('bebidas', 'fanta', 56, NULL, 56, 56, 'paredes'),
('bebidas', 'fanta 1 litros', 78, NULL, 78, 78, 'paredes'),
('bebidas', 'sprite 1 litros', 54, NULL, 90, 203, 'paredes'),
...
('def', 'flashbd', 'cadetes', 'idCadete', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'usuarios_username', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'nombre', 3, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'apellido', 4, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'direccion', 5, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'telefono', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'cadetes', 'email', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'categorias', 'nombreCategoria', 1, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'categorias', 'imagen', 2, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'categorias', 'usuarios_username', 3, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'categorias', 'color', 4, '5', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'idclientes', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'nombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'apellido', 3, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'direccion', 4, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'telefono', 5, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'email', 6, NULL, 'YES', 'varchar', 80, 240, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'clientes', 'usuarios_username', 7, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos', 'nroPedido', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos', 'idCliente', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos', 'usuarios_username', 3, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos', 'idCadete', 4, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos', 'fecha', 5, 'CURRENT_TIMESTAMP', 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos_has_productos', 'nroPedido', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos_has_productos', 'nombreProducto', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos_has_productos', 'cantidad', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'pedidos_has_productos', 'username', 4, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'nombreCategoria', 1, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'nombreProducto', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'stock', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'imagen', 4, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'costo', 5, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'precio', 6, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'productos', 'usuarios_username', 7, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'username', 1, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'nombre', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'apellido', 3, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'direccion', 4, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'telefono', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'email', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'empresa', 7, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'flashbd', 'usuarios', 'password', 8, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '10'),
('HANDLER_READ_FIRST', '305'),
('HANDLER_READ_KEY', '468'),
('HANDLER_READ_LAST', '1'),
('HANDLER_READ_NEXT', '446'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '8051'),
('HANDLER_ROLLBACK', '3'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '6745'),
('INNODB_BUFFER_POOL_PAGES_DATA', '406'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '148'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '17964'),
('INNODB_BUFFER_POOL_READS', '395'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '368'),
('INNODB_DATA_FSYNCS', '47'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8654848'),
('INNODB_DATA_READS', '405'),
('INNODB_DATA_WRITES', '112'),
('INNODB_DATA_WRITTEN', '2460672'),
('INNODB_DBLWR_PAGES_WRITTEN', '74'),
('INNODB_DBLWR_WRITES', '9'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '45'),
...
('INNODB_PAGES_READ', '394'),
('INNODB_PAGES_WRITTEN', '74'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '14140'),
('UPTIME_SINCE_FLUSH_STATUS', '14140');
...
('DATADIR', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\data\\'),
...
('BASEDIR', 'c:/wamp2/bin/mysql/mysql5.5.24'),
...
('CHARACTER_SETS_DIR', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\share\\charsets\\'),
('LOG_BIN', 'ON'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\share\\'),
...
('PID_FILE', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\data\\notebook.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\data\\notebook.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'c:\\wamp2\\logs\\mysql.log'),
...
('PLUGIN_DIR', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp2\\bin\\mysql\\mysql5.5.24\\data\\notebook-slow.log'),
...
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'cadetes', 'idCadete', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'cadetes', 'usuarios_username', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_cadetes_usuarios1', 'def', 'flashbd', 'cadetes', 'usuarios_username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'categorias', 'nombreCategoria', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'categorias', 'usuarios_username', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_categorias_usuarios1', 'def', 'flashbd', 'categorias', 'usuarios_username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'clientes', 'idclientes', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'clientes', 'usuarios_username', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_clientes_usuarios1', 'def', 'flashbd', 'clientes', 'usuarios_username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos', 'nroPedido', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos', 'idCliente', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos', 'usuarios_username', 3, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos', 'idCadete', 4, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_pedidos_cadetes1', 'def', 'flashbd', 'pedidos', 'idCadete', 1, 1, 'flashbd', 'cadetes', 'idCadete'),
('def', 'flashbd', 'fk_pedidos_clientes1', 'def', 'flashbd', 'pedidos', 'idCliente', 1, 1, 'flashbd', 'clientes', 'idclientes'),
('def', 'flashbd', 'fk_pedidos_usuarios1', 'def', 'flashbd', 'pedidos', 'usuarios_username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos_has_productos', 'nroPedido', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos_has_productos', 'nombreProducto', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'pedidos_has_productos', 'username', 3, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_pedidos_has_productos_pedidos1', 'def', 'flashbd', 'pedidos_has_productos', 'nroPedido', 1, 1, 'flashbd', 'pedidos', 'nroPedido'),
('def', 'flashbd', 'fk_pedidos_has_productos_productos1', 'def', 'flashbd', 'pedidos_has_productos', 'nombreProducto', 1, 1, 'flashbd', 'productos', 'nombreProducto'),
('def', 'flashbd', 'fk_pedidos_has_productos_usuarios1', 'def', 'flashbd', 'pedidos_has_productos', 'username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'productos', 'nombreCategoria', 1, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'productos', 'usuarios_username', 2, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'productos', 'nombreProducto', 3, NULL, NULL, NULL, NULL),
('def', 'flashbd', 'fk_productos_usuarios1', 'def', 'flashbd', 'productos', 'usuarios_username', 1, 1, 'flashbd', 'usuarios', 'username'),
('def', 'flashbd', 'productos_ibfk_1', 'def', 'flashbd', 'productos', 'nombreCategoria', 1, 1, 'flashbd', 'categorias', 'nombreCategoria'),
('def', 'flashbd', 'PRIMARY', 'def', 'flashbd', 'usuarios', 'username', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2016-07-27 03:22:22', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'cadetes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'categorias', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'clientes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'pedidos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 65536, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'pedidos_has_productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 49152, 6291456, '2016-07-25 00:11:52', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 49152, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flashbd', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 6291456, '2016-07-25 00:01:55', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2016-07-17 23:53:44', NULL, NULL, '', '', NULL),
...
(280, 'root', 'localhost:3161', 'flashbd', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'flashbd', 'fk_cadetes_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'cadetes', 'usuarios'),
('def', 'flashbd', 'fk_categorias_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'categorias', 'usuarios'),
('def', 'flashbd', 'fk_clientes_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'clientes', 'usuarios'),
('def', 'flashbd', 'fk_pedidos_cadetes1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos', 'cadetes'),
('def', 'flashbd', 'fk_pedidos_clientes1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos', 'clientes'),
('def', 'flashbd', 'fk_pedidos_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos', 'usuarios'),
('def', 'flashbd', 'fk_pedidos_has_productos_pedidos1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos_has_productos', 'pedidos'),
('def', 'flashbd', 'fk_pedidos_has_productos_productos1', 'def', 'flashbd', 'nombreProducto_UNIQUE', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos_has_productos', 'productos'),
('def', 'flashbd', 'fk_pedidos_has_productos_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'pedidos_has_productos', 'usuarios'),
('def', 'flashbd', 'fk_productos_usuarios1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'productos', 'usuarios'),
('def', 'flashbd', 'productos_ibfk_1', 'def', 'flashbd', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'productos', 'categorias');
...
('def', 'flashbd', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '18405'),
('INNODB_BUFFER_POOL_READS', '395'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '368'),
('INNODB_DATA_FSYNCS', '47'),
...
('def', 'flashbd', 'cadetes', 0, 'flashbd', 'PRIMARY', 1, 'idCadete', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'cadetes', 0, 'flashbd', 'PRIMARY', 2, 'usuarios_username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'cadetes', 1, 'flashbd', 'fk_cadetes_usuarios1_idx', 1, 'usuarios_username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'categorias', 0, 'flashbd', 'PRIMARY', 1, 'nombreCategoria', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'categorias', 0, 'flashbd', 'PRIMARY', 2, 'usuarios_username', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'categorias', 1, 'flashbd', 'fk_categorias_usuarios1_idx', 1, 'usuarios_username', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'clientes', 0, 'flashbd', 'PRIMARY', 1, 'idclientes', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'clientes', 0, 'flashbd', 'PRIMARY', 2, 'usuarios_username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'clientes', 1, 'flashbd', 'fk_clientes_usuarios1_idx', 1, 'usuarios_username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 0, 'flashbd', 'PRIMARY', 1, 'nroPedido', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 0, 'flashbd', 'PRIMARY', 2, 'idCliente', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 0, 'flashbd', 'PRIMARY', 3, 'usuarios_username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 0, 'flashbd', 'PRIMARY', 4, 'idCadete', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 1, 'flashbd', 'fk_pedidos_clientes1_idx', 1, 'idCliente', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 1, 'flashbd', 'fk_pedidos_usuarios1_idx', 1, 'usuarios_username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 1, 'flashbd', 'fk_pedidos_cadetes1_idx', 1, 'idCadete', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos', 1, 'flashbd', 'nroPedido', 1, 'nroPedido', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 0, 'flashbd', 'PRIMARY', 1, 'nroPedido', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 0, 'flashbd', 'PRIMARY', 2, 'nombreProducto', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 0, 'flashbd', 'PRIMARY', 3, 'username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 1, 'flashbd', 'fk_pedidos_has_productos_productos1_idx', 1, 'nombreProducto', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 1, 'flashbd', 'fk_pedidos_has_productos_pedidos1_idx', 1, 'nroPedido', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'pedidos_has_productos', 1, 'flashbd', 'fk_pedidos_has_productos_usuarios1_idx', 1, 'username', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 0, 'flashbd', 'PRIMARY', 1, 'nombreCategoria', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 0, 'flashbd', 'PRIMARY', 2, 'usuarios_username', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 0, 'flashbd', 'PRIMARY', 3, 'nombreProducto', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 1, 'flashbd', 'fk_productos_categorias1_idx', 1, 'nombreCategoria', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 1, 'flashbd', 'fk_productos_usuarios1_idx', 1, 'usuarios_username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'productos', 1, 'flashbd', 'nombreProducto_UNIQUE', 1, 'nombreProducto', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'usuarios', 0, 'flashbd', 'PRIMARY', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flashbd', 'usuarios', 1, 'flashbd', 'username_UNIQUE', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-07-27 03:22:22', '2016-07-27 03:22:22', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2016-07-27 03:22:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'flashbd', 'cadetes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, NULL, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'categorias', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 6291456, NULL, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'clientes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 6291456, 13, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'pedidos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 65536, 6291456, 2, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'pedidos_has_productos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 49152, 6291456, NULL, '2016-07-25 00:11:52', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'productos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 49152, 6291456, NULL, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'flashbd', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 6291456, NULL, '2016-07-25 00:01:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2016-07-17 23:53:44', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'flashbd', 'PRIMARY', 'flashbd', 'cadetes', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_cadetes_usuarios1', 'flashbd', 'cadetes', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'categorias', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_categorias_usuarios1', 'flashbd', 'categorias', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'clientes', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_clientes_usuarios1', 'flashbd', 'clientes', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'pedidos', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_pedidos_cadetes1', 'flashbd', 'pedidos', 'FOREIGN KEY'),
('def', 'flashbd', 'fk_pedidos_clientes1', 'flashbd', 'pedidos', 'FOREIGN KEY'),
('def', 'flashbd', 'fk_pedidos_usuarios1', 'flashbd', 'pedidos', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'pedidos_has_productos', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_pedidos_has_productos_pedidos1', 'flashbd', 'pedidos_has_productos', 'FOREIGN KEY'),
('def', 'flashbd', 'fk_pedidos_has_productos_productos1', 'flashbd', 'pedidos_has_productos', 'FOREIGN KEY'),
('def', 'flashbd', 'fk_pedidos_has_productos_usuarios1', 'flashbd', 'pedidos_has_productos', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'productos', 'PRIMARY KEY'),
('def', 'flashbd', 'fk_productos_usuarios1', 'flashbd', 'productos', 'FOREIGN KEY'),
('def', 'flashbd', 'productos_ibfk_1', 'flashbd', 'productos', 'FOREIGN KEY'),
('def', 'flashbd', 'PRIMARY', 'flashbd', 'usuarios', 'PRIMARY KEY'),
